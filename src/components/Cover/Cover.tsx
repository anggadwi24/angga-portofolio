...
export default function Cover({ profileData }: { profileData: Profile }) {
    ...
    return (
        <section ref={sectionRef} className="relative flex items-center justify-center w-screen h-screen bg-white">
                ...
                <div className='w-full flex flex-col lg:flex-row justify-between items-center gap-4'>
                    <div ref={textRef} className='w-3/4 order-2 lg:order-1 flex flex-col gap-3'>
                        <div className='flex flex-col gap-1'>
                            <h1 className='font-extrabold text-xl lg:text-4xl tracking-wide text-center lg:text-left text-blue-600'>{profileData.name}</h1>
                            <h6 className='font-medium text-sm lg:text-lg tracking-none lg:tracking-wide text-center lg:text-left'>{profileData.jobTitle}</h6>
                        </div>
                    ...
                    <div ref={imageRef} className='w-full lg:w-1/3 order-1 lg:order-2 flex items-center justify-center cursor-pointer'>
                        {profileData.image && (
                            <Image
